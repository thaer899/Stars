...
public class GestionHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Table_Discussion = new javax.swing.JTable();
        bt_forum = new javax.swing.JButton();
        ...
        Table_Tag1.setModel(new ListCategorie());
        ...
        jPanel8.add(bt_delete);
        bt_delete.setBounds(170, 220, 63, 23);

        Table_Discussion.setModel(new ListeDiscussion());
        jScrollPane1.setViewportView(Table_Discussion);

        jPanel8.add(jScrollPane1);
        jScrollPane1.setBounds(10, 80, 380, 90);

        bt_forum.setText("Open Web Page");
        bt_forum.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bt_forumActionPerformed(evt);
            }
        });
        jPanel8.add(bt_forum);
        bt_forum.setBounds(20, 30, 130, 23);
        jPanel8.add(jLabel9);
    ...
    private void Bt_Admin_Tag_AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bt_Admin_Tag_AddActionPerformed
        // TODO add your handling code here:
        GestionNotification appelFenetre = new GestionNotification();
        appelFenetre.setVisible(true);
        setVisible(false);
    }//GEN-LAST:event_Bt_Admin_Tag_AddActionPerformed

    private void bt_forumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_forumActionPerformed
            try {
            String URL= "https://www.google.tn/";
            java.awt.Desktop.getDesktop().browse(java.net.URI.create(URL));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
        }

    }//GEN-LAST:event_bt_forumActionPerformed

    private void bt_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_deleteActionPerformed
         try {
            AbstractTableModel model =(AbstractTableModel) Table_Discussion.getModel();
            Discussion discussion=new Discussion();
            discussion.setClient_id(Integer.parseInt(model.getValueAt(Table_Discussion.getSelectedRow(), 2).toString()));
            IDiscussionDAO discussiondao= DiscussionDAO.getInstance();
            discussiondao.deleteDiscussion(Integer.parseInt(model.getValueAt(Table_Discussion.getSelectedRow(), 2).toString()));
